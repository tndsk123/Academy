package community_job.dto;

import java.sql.Date;

public class Community_jobDTO {
	private int num;
	...
	public String toString() {
		return "Community_jobDTO [num=" + num + ", writer=" + writer + ", subject=" + subject + ", passwd=" + passwd
				+ ", reg_date=" + reg_date + ", job_area=" + job_area + ", readcount=" + readcount + ", ref=" + ref
