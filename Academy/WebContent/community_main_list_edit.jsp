...
$(function(){
	$("#btnUpdate").click(function(){
		...
		document.form1.action="${path}/community_main_servlet/community_main_update.do";
		document.form1.submit();
	});
	$("#btnDelete").click(function(){
		if(confirm("정말 삭제 하시겠습니까?")){
			document.form1.action="${path}/community_main_servlet/community_main_delete.do";
			document.form1.submit();
		}else{
			return;
		}
  		  ...
  		  <div class="row">
      		 <div class="col-md-12 mt-2">
      		 	...
      		 	<table class="table table-bordered table-responsive-sm">
      		 		...
      		 		<tr>
    					<td>날짜</td>
    					<td class="form-group"><input name="reg_date" value="${dto.reg_date}" disabled style="border: none; background-color: white;"></td>
    					<td>조회수</td>
