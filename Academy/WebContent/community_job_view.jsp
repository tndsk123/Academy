...
$(function(){
	$("#writecommit").click(function(){
		...
		document.write.action="${path}/community_job_servlet/insert.do?writer="+writer;
	...
	$("#btnList").click(function(){
		location.href="${path}/community_job_servlet/list.do";
	});
	$("#btnEdit").click(function(){
		...
		document.form1.action="${path}/community_job_servlet/pass_check.do";
...
function like_good(){
	$.ajax({
		type: "post",
		url: "${path}/community_job_servlet/like_good.do",
		data: "num=${dto.num}",
		success: function(){
			location.reload();
		}
...
function prePage() {
	...
	location.href="${path}/community_job_servlet/view.do?num="+num;
}
function nextPage() {
	var num=${dto.num}-1;
	if(num<=0){
		...
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item dropdown">
				...
				<div class="text-center dropdown-menu" aria-labelledby="dropdown">
					...
					<a class="dropdown-item mt-2" href="${path}/community_job_servlet/list.do?nickname=<%=nickname%>">정보교환</a>
  		  ...
  		  <div class="row">
      		 <div class="col-sm-12 mt-2">
      		 	...
      		 	<table class="table table-bordered" >
      		 		<tr class="table-info">
      		 			<th colspan="4">게시판 > 자유게시판 > 세부게시판</th>
      		 		</tr>
      		 		<tr>
    					<td width="20%">날짜</td>
    					<td>${dto.reg_date}</td>
  					...
  					<tr>
    					...
    					<td colspan="3">
      						<c:if test="${dto.filesize > 0}">
        						...
        						<a href="${path}/community_job_servlet/download.do?num=${dto.num}">[다운로드]</a>
      						</c:if>
    					</td>
  					</tr>		
  				  </table>
  				  <div class="col-sm-12 mt-3" id="good_comment" align="center">
  				  	...
  				  	<button type="button" class="btn btn-danger mt-3 ml-4" id="btnList" >목록</button>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="${path}/community_job_servlet/insert.do" id="write" name="write" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							<label>모집분야</label>
							<input name="job_area" id="job_area" class="form-control">
						</div>
						<div class="form-group">
							<label>제목</label>
