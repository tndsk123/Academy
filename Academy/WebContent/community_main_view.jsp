...
$(function(){
	...
	$("#btnList").click(function(){
		location.href="${path}/community_main_servlet/list.do";
	});
	$("#btnEdit").click(function(){
		...
		document.form1.action="${path}/community_main_servlet/pass_check.do";
...
function comment_list(){
	$.ajax({
		type: "post",
		url: "${path}/community_main_servlet/commentList.do",
		data: "num=${dto.num}",
...
function comment_add(){
	...
	$.ajax({
		type: "post",
		url: "${path}/community_main_servlet/comment_add.do",
		data: param,
		success: function(){
			$("#co_content").val("");
			comment_list();
...
function like_good(){
	$.ajax({
		type: "post",
		url: "${path}/community_main_servlet/like_good.do",
		data: "num=${dto.num}",
		success: function(){
			location.reload();
		}
  					...
  					<tr>
    					...
    					<td colspan="3">
      						<c:if test="${dto.filesize > 0}">
        						...
        						<a href="${path}/community_main_servlet/download.do?num=${dto.num}">[다운로드]</a>
      						</c:if>
    					</td>
  					</tr>		
  				  </table>
