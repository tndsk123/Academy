...
$(function(){
	...
	$("#writecommit").click(function(){
		...
		document.write.action="${path}/community_exchange_servlet/insert.do?writer="+writer;
	...
	$("#btnList").click(function(){
		location.href="${path}/community_exchange_servlet/list.do";
	});
	$("#btnEdit").click(function(){
		...
		document.form1.action="${path}/community_exchange_servlet/pass_check.do";
...
function comment_list(){
	$.ajax({
		type: "post",
		url: "${path}/community_exchange_servlet/commentList.do",
		data: "num=${dto.num}",
...
function comment_add(){
	...
	$.ajax({
		type: "post",
		url: "${path}/community_exchange_servlet/comment_add.do",
		data: param,
		success: function(){
			$("#co_content").val("");
			comment_list();
...
function like_good(){
	$.ajax({
		type: "post",
		url: "${path}/community_exchange_servlet/like_good.do",
		data: "num=${dto.num}",
		success: function(){
			location.reload();
		}
...
function prePage() {
	...
	location.href="${path}/community_exchange_servlet/view.do?num="+num;
}
function nextPage() {
	var num=${dto.num}-1;
	if(num<=0){
  					...
  					<tr>
    					...
    					<td colspan="3">
      						<c:if test="${dto.filesize > 0}">
        						...
        						<a href="${path}/community_exchange_servlet/download.do?num=${dto.num}">[다운로드]</a>
      						</c:if>
    					</td>
  					</tr>		
  				  </table>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="${path}/community_exchange_servlet/insert.do" id="write" name="write" method="post" enctype="multipart/form-data">
