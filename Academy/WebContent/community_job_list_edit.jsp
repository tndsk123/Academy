...
$(function(){
	$("#btnUpdate").click(function(){
		...
		document.form1.action="${path}/community_job_servlet/community_job_update.do";
		document.form1.submit();
	});
	$("#btnDelete").click(function(){
		if(confirm("정말 삭제 하시겠습니까?")){
			document.form1.action="${path}/community_job_servlet/community_job_delete.do";
			document.form1.submit();
		}else{
			return;
		}
...
<body>
  		  ...
  		  <div class="row">
      		 <div class="col-sm-12 mt-2">
      		 	...
      		 	<table class="table table-bordered" >
      		 		<tr class="table-info">
      		 			<th colspan="4">게시판 > 자유게시판 > 세부게시판 > 게시물수정/삭제</th>
      		 		</tr>
      		 		<tr>
    					<td width="20%">날짜</td>
  					...
  					<tr>
    					<td>모집분야</td>
    					<td colspan="3"><input name="job_area" id="job_area" value="${dto.job_area}"></td>
  					</tr>
  					<tr>
    					<td>이름</td>
	...
	<footer class="mt-4 p-5 text-center" >
		Copyright &copy; 2020 김영수 All Rights Reserved
	</footer>
</body>
</html>