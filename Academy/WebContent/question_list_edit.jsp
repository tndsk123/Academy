...
$(function(){
	$("#btnUpdate").click(function(){
		...
		document.form1.action="${path}/question_servlet/community_main_update.do";
		document.form1.submit();
	});
	$("#btnDelete").click(function(){
		if(confirm("정말 삭제 하시겠습니까?")){
			document.form1.action="${path}/question_servlet/community_main_delete.do";
			document.form1.submit();
		}else{
			return;
		}
  		  ...
  		  <div class="row">
      		 <div class="col-sm-12 mt-2">
      		 	...
      		 	<table class="table table-bordered" >
      		 		<tr class="table-info">
      		 			<th colspan="4">고객센터 > 세부게시판 > 게시물수정/삭제</th>
      		 		</tr>
      		 		<tr>
    					<td>날짜</td>
