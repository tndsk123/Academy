...
$(function(){
	$("#writecommit").click(function(){
		...
		document.write.action="${path}/community_main_servlet/insert.do?writer="+writer;
...
function list_change(page) {
	...
	location.href="${path}/community_main_servlet/list.do?curPage="+page+"&sequence="+sequence;	
}
function list_view() {
	document.list.action="${path}/community_main_servlet/list.do";
      		 		...
      		 		<c:forEach var="dto" items="${list}">
      		 		    <c:choose>
      		 		    	<c:when test="${dto.writer == '관리자' }">
      		 						...
      		 						<td>${dto.writer}</td>
      		 						<td>
      		 							<a href="${path}/community_main_servlet/view.do?num=${dto.num}" style="color: blue;">${dto.subject}</a>
      		 						...
      		 						<td align="center">
      									<c:if test="${dto.filesize > 0}">
      										<a href="${path}/community_main_servlet/download.do?num=${dto.num}" style="color: black;">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="${path}/community_main_servlet/insert.do" id="write" name="write" method="post" enctype="multipart/form-data">
